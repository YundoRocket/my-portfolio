...
const projects = [
  {
    ...
    title: "Girasol",
    description:
      "Girasol is a fun and simple decentralized prediction market on Solana. Predict whether SOL price will rise, fall, or stay within a range (Flat) – guess correctly to win.",
  ...
  },
  {
    ...
    description:
      "BattleBoosters is a fantasy MMA NFT card game on Solana that offers players a thrilling, immersive experience based on real MMA league fights.",
  ...
  },
  {
    ...
    title: "LoTerra",
    description:
      "LoTerra was a decentralized lottery platform powered by LOTA token holders, enabling fair and transparent gaming experiences on the Terra blockchain.",
  ...
  return (
    ...
    >
      <div className="text-center mb-12">
        ...
        <div className="text-xl mt-10 p-4">
